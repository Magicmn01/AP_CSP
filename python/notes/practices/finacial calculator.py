...
print("your groceries is" , "$" , groceries , "and that is", percent(groceries) , "%" , "of your income.")
print("your transportsaiton is" , "$" , transportaiton , "and that is", percent(transportaiton) , "%" , "of your income.")
